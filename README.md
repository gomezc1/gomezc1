...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,java,py,vscode,git,idea,netlify,npm,react,bootstrap,cpp,ubuntu,visualstudio,codepen,postgres,arduino,replit,sqlite,figma,ps,c,raspberrypi,docker,latex,kali,linux&perline=10)](https://skillicons.dev)
